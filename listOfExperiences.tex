...
{Lawrence Livermore Nat’l Lab$\>$$\>$$\>$$\>$Summer Scholar$\>$$\>$$\>$$\>$May. '10 - Aug. '10}
\begin{itemize}
...
{\small Goldman-Sachs$\>\>\>\>$Summer Analyst$\>\>\>\>$Jun. ‘09 – Sep. ‘09}
\vspace*{-0.0in}
\begin{itemize}
\small \item \small Wrote code for testing trading system infrastructure functions under extreme market conditions.
\item \small Analyzed performance bottlenecks of system infrastructure functions.
\end{itemize}

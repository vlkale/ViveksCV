...
\begin{itemize}
   ...
   \item Leading hackathons (including virtual) for using OpenMP on Department of Energy's Exascale Supercomputers.
...
\textbf{Goldman-Sachs$\>\>\>\>$Summer Analyst$\>\>\>\>$Jun. ‘09 – Sep. ‘09}
\vspace*{-0.0in}
\begin{itemize}

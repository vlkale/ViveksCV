...
\begin{center}
    ...
    \normalsize
    	...
    	extbf{Phone:} \href{tel:+16507339327}{(650) 733-9327} | \textbf{Email}: \href{mailto:vivek.lkale@gmail.com}{vivek.lkale@gmail.com} | 
        	extbf{LinkedIn}: \href{https://www.linkedin.com/in/vlkale}{linkedin.com/in/vlkale} 

	extbf{GitHub}: \href{https://github.com/vlkale}{github.com/vlkale} | \textbf{Website}: \href{https://vlkale.github.io}{vlkale.github.io} | \textbf{U.S. citizen with Secret clearance}
\end{center}
\noindent\rule{\linewidth}{0.4pt}

\vspace{-0.1in}

% Reordered for AI GPU Performance Engineer focus
\section*{\fontfamily{\myResumeFont}\selectfont Professional Summary}
\input{ProfessionalSummary}

% Spotlight Technical Skills early for GPU/Profiling emphasis
\section*{\fontfamily{\myResumeFont}\selectfont Technical Skills}
\input{listOfSkillSetsForResume}

% Bring key GPU kernel experience forward
...
% Projects next to highlight kernel/compilers work

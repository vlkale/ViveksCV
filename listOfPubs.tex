...
\underline{Papers}
\begin{enumerate} 
\item Jonas H Müller Korndörfer, Florina M. Ciorba, Akan Yilmaz, Christian Iwainsky, Johannes Doerfert, Hal Finkel, Vivek Kale, Michael Klemm. \textit{A Runtime Approach for Dynamic Load Balancing of OpenMP Parallel Loops in LLVM}. The International Conference for High Performance Computing Networking, Storage, and Analysis. November 19, 2019. Denver, Colorado, USA. 
\item Vivek Kale, Christian Iwainsky, Michael Klemm, Jonas H. Muller Korndorfer, Florina M. Ciorba. \textit{Toward a Standard Interface for User-Defined Scheduling in OpenMP}. International Workshop on OpenMP. September 23, 2019. Auckland, New Zealand. 
